...
export class Utils {
    ...
    static calDate(type) {
        ...
        if (type === 1) {
            ...
            t = new Date().getTime() - 3 * 60 * 60 * 1000;   //24小时 * 60分钟 * 60秒 * 1000
            d = new Date(t);
        } else if (type === 6) {
            t = new Date().getTime() - 6 * 60 * 60 * 1000;   //24小时 * 60分钟 * 60秒 * 1000
            d = new Date(t);
        } else if (type === 12) {
            t = new Date().getTime() - 12 * 60 * 60 * 1000;   //24小时 * 60分钟 * 60秒 * 1000
            d = new Date(t);
        }else if (type === 24) {
    ...
    static utc2beijing(utc_datetime) {
        ...
        var hour_minute_second = utc_datetime.substr(T_pos + 1);
        var new_datetime = year_month_day + " " + hour_minute_second; 


        return new_datetime.replace(/-/g,"/"); 
    }
